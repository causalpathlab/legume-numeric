...
/// under: `feature.lora_u` and `feature.lora_v` (see [`crate::candle::lora`]).
...
/// low-rank residual trained on top ([`crate::candle::lora`]). The base is registered
...
impl FeatureEmbedding {
    ...
    /// [`crate::candle::grow::new_slab_value`].
    pub fn new(
        n_features: usize,
        n_modules: usize,
        embedding_dim: usize,
    ...
    /// variant and [`crate::candle::lora`] for the initialization).
    pub fn new_lora(
        n_features: usize,
        embedding_dim: usize,
        rank: usize,
...
/// [`crate::candle::lora::fold`] for the feature table registered under `prefix`:
