...
//!
//! The MST + centroids come from [`crate::matrix::principal_graph`] (k-means centroids +
//! [`crate::matrix::principal_graph::mst_from_sqdist`]); orientation/root selection is
...
/// (as returned by [`crate::matrix::principal_graph::mst_from_sqdist`]); `root` is the
